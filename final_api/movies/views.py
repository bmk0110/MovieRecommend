...
from .models import Movie, Genre,  Rating, GenreCount
from .serializers import MovieListSerializer, RatingSerializer, RatingListSerializer, GenreSerializer,GenreCountSerializer
...
def rating_create(request, movie_pk):
    ...
    if serializer.is_valid():
        ...
        for genre in movie.genres.all():
            ...
            genre_count = get_object_or_404(GenreCount, genre=genre)
            # print(genre_count)
            if genre_count.exist():
